package com.naturalprogrammer.spring.sample.controllers;
...
public class UserController {
	...
	public String Verify(@PathVariable("verificationCode") String verificationCode,RedirectAttributes redirectAttributes, HttpServletRequest request) throws ServletException
	{
